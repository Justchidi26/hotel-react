  ...
  return (
    <div>
      ...
      <div className="flex gap-4 pr-[30px] pl-[30px]">
        <div className="group flex flex-col items-center justify-center border-2 border-[#00aeff] rounded-md p-4 h-25 w-40 hover:bg-[#00aeff] transition duration-700 ease-in-out">
